...
# Building: export INCLUDE=".:$MOZ_FETCHES_DIR/vs/VC/Tools/MSVC/14.50.35717/atlmfc/include:$MOZ_FETCHES_DIR/vs/VC/Tools/MSVC/14.50.35717/include"
...
OBJECTS  = $(DEP)/portable.o $(DEP)/general.o $(DEP)/ice_error.o  $(DEP)/safe_ex.o \
           ...
           $(DEP)/cpu_avx.o $(DEP)/cpu_avx512.o $(DEP)/cpu_info.o $(DEP)/win_registry.o \
